...
import net.necrokochou.testmod.item.custom.DrinkItem;
...
public class ModItems {
    ...
    public static final Item MILO_DRINK = registerItem("milo_drink", new DrinkItem(new Item.Settings()
            .food(ModFoodComponents.MILO_DRINK)) {
        @Override
        public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
            tooltip.add(Text.translatable("tooltip.testmod.milo_drink"));
